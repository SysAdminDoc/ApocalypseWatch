# Build and operate ApocalypseWatch v0.2.3
...
The existing Pages deployment has not been refreshed for v0.2.3. The release downloads and current repository are the verified delivery paths.
