# ApocalypseWatch v0.2.3 screenshots
...
![Dark desktop overview](dashboard-dark.png)

![Light desktop overview](dashboard-light.png)

![History chart and data coverage](history-dark.png)

![Evidence packet and sensitivity controls](evidence-dark.png)

![Narrow layout](mobile-dark.png)
